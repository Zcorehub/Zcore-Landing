        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <Reveal variant="right">
            ...
            <div className="space-y-4">
              <div className="p-5 rounded-2xl border border-indigo-500/20 bg-indigo-500/[0.06]">
                <div className="flex items-center gap-4">
                  <div className="w-1.5 h-14 rounded-full bg-gradient-to-b from-indigo-400 to-indigo-600" />
                  <div>
                    <p className="font-bold text-lg">Stellar Base</p>
                    <p className="text-white/40 text-sm">
                      Age, volume, success rate, balance
                    </p>
                    <p className="text-indigo-300 font-mono text-sm mt-2">
                      max 150 pts
                    </p>
                  </div>
                </div>
              </div>
              <div className="p-5 rounded-2xl border border-violet-500/20 bg-violet-500/[0.06]">
                <div className="flex items-center gap-4">
                  <div className="w-1.5 h-14 rounded-full bg-gradient-to-b from-violet-400 to-violet-600" />
                  <div>
                    <p className="font-bold text-lg">Partner Events</p>
                    <p className="text-white/40 text-sm">
                      Escrows, loans, tandas — verified by protocols
                    </p>
                    <p className="text-violet-300 font-mono text-sm mt-2">
                      max 700 pts
                    </p>
                  </div>
                </div>
              ...
              <div className="h-3 rounded-full overflow-hidden flex bg-white/[0.04]">
                <div className="w-[17.6%] bg-indigo-500" title="Stellar 150/850" />
                <div className="w-[82.4%] bg-violet-500/80" title="Events 700/850" />
              </div>
          ...
          <Reveal delay={150} variant="left">
            <div className="rounded-2xl border border-white/[0.08] bg-[#0a0e1a]/80 overflow-hidden">
              ...
              <div className="px-5 py-2 border-b border-white/[0.06] text-[10px] font-medium text-white/30 uppercase tracking-widest grid grid-cols-3">
                <span>Component</span>
              ...
              {SCORE_COMPONENTS.map(({ component, max, source }) => (
                ...
                >
                  ...
                  <span className="text-sm text-center font-mono font-bold text-emerald-400">
                    {max}
                  </span>
